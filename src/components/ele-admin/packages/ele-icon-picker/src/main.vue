...
<template>
  <el-popover
    v-model="show"
    :width="width"
    popper-class="ele-icon-picker-popper"
          ...
          <el-row>
            <el-col :span="4" v-for="(d,i) in item.icons" :key="i">
              <el-card shadow="hover" class="ele-card-border" :title="d">
                <div class="ele-icon-picker-item" @click="choose(d)">
                  <i :class="d"/>
                </div>
              </el-card>
            </el-col>
...
.ele-icon-picker-open.ele-icon-picker-style3 .el-input-group__append .el-icon-arrow-down {
